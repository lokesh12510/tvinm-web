    ...
    return (
        <>
            <Head>
                ...
                <meta name="title" content="Privacy policy - Thambatty Vivekanandar Illaignar Narpani Mandram"></meta>
                <meta
                    name="description"
                    content="privacy policy - Thambatty Vivekanandar Illaignar Narpani Mandram is affiliated with Nehru Yuva Kendra, The Nilgiris District which is under Government of India- Ministry of Youth Affairs and Sports."
                ></meta>
            </Head>
            <section className="py-[48px] container max-w-screen-lg mx-auto px-3">
                ...
                <p>
                    ...
                    with regards to the information that they shared and/or collect in TVINM. This policy is not
                ...
                <p>
                    You may consult this list to find the Privacy Policy for each of the advertising partners of TVINM.
                </p>
                ...
                <p>
                    Note that TVINM has no access to or control over these cookies that are used by third-party
                    advertisers.
                </p>
                ...
                <p>
                    TVINM does not knowingly collect any Personal Identifiable Information from children under the age
