    ...
    <>
      ...
      <div className="w-full h-[220px] md:h-[300px] relative flex items-center flex-col justify-center text-center overflow-hidden">
        ...
        <div className=" z-[2] mb-4">
          <h3 className="text-3xl font-bold italic space-x-2 mb-4 text-white">
            About Us
          </h3>
      ...
      <section className="mx-auto container max-w-screen-lg px-3 py-[40px]">
        <p className="mb-7">
          ...
          services to the people. It is officially registered under the Tamil
          Nadu Societies Registration Act, 1975 (Tamil Nadu Act 27 of
          1975).&nbsp;
        ...
        <h3 className="font-bold mb-4 text-lg">
          DECEMBER 27, 2019- Start of Society Club
        </h3>
        <p className="mb-3">
          A society club under the name of “Vivekanandar Illaignar Narpani
          Mandram Thambatty” was formed by our village seniors and they did a
          great job. In order to continue the same services we decided to start
          a new club under the name of “Thambatty Vivekanandar Illaignar Narpani
          Mandram”. We requested a room and got permission from our Village Head
          B.Iyer to use it for our society club. We received an affiliation
          certificate from the Nehru Yuva Kendra- The Nilgiris.
        </p>
        <div className="md:w-[50vw] m-auto h-[170px] md:h-[300px] relative mb-6">
          <Image
            src={"/images/about/tvinm-certificate.jpg"}
            alt="tvinm certification"
            fill
          />
        </div>
        <p className="mb-3">
          With 23 active members we started this society club. Along with the
          village kids, we decided to clean our village ground which was near
          Thambatty Mariamman Temple. The allotted room was used to conduct
          daily meetings and everyone participated. Everyone was given the
          opportunity to talk and share their opinion. Out of 23 active members,
          5 people were given the title of President, Secretary, Treasurer,
          Vice-President and Vice-Secretary.{" "}
        </p>
        <h3 className="font-bold mb-4 text-lg">
          FEBRUARY 24, 2020- Registration
        </h3>
        <p className="mb-3">
          On this day, our society club “Thambatty Vivekanandar Illaignar
          Narpani Mandram” was officially registered under the Tamil Nadu
          Societies Registration Act, 1975 (Tamil Nadu Act 27 of 1975) and we
        ...
        <p className="mb-3">
          December 27, 2019- Start of Society club and received an affiliation
          certificate from Nehru Yuva Kendra, The Nilgiris- Government of India.
        </p>
        <p className="mb-3">
          December 28, 2019- Competition 1- Organized a few competitions for
          Kids. (Chess, Carrom, Badminton)
        </p>
        <h3 className="font-bold my-4 text-3xl">2020</h3>
        <p className="mb-3">
          January 18, 2020- Started Plastic Free society camp by collecting
...
`}</p>
        <p className="mb-3">
          June 10, 2021- Tree plantation activity. Planted tree saplings in and
          around the Village.{" "}
        </p>
        <p className="mb-3">
          June 21, 2021- Yoga day program was organized at our village.{" "}
        </p>
        <p className="mb-3">
          August 29, 2021- National Sports day was celebrated at our village
          with kids participating in it.{" "}
        </p>
        <p className="mb-3">
          October 2021- Fit India Freedom Run 2.0 was organized with the help of
          NYK providing us with fund.
        </p>
        <h3 className="font-bold my-4 text-3xl">2022</h3>
        <p className="mb-3">
          January 1, 2022- TVINM App launching Event and the release of Village
          History Documentary.{" "}
        </p>
        <p className="mb-3">
        ...
        <p className="mb-3">
          February 20, 2022- Rs. 10000 was received from “Sri Sathya Sai Maruthi
          Seva Charitable Trust” as a honourable gift.
        </p>
        <p className="mb-3">{`March 27, 2022- "Social Worker Award'' was honoured to our Club by BADUGAR KALACHARA PADHUKAPPU IYAKKAM.`}</p>
        <p className="mb-3">
          March 30, 2022- Sports materials were received from NYK.{" "}
        </p>
        <p className="mb-3">
          {" "}
          May 29, 2022- Honoring our former village Head B. Iyer for his
          continuous services over the past years.{" "}
        </p>
        <p className="mb-3">
          June 19, 2022- Talent Chase- An online competition prize distribution
          program was organized in ooty at the Hoticulture Complex with chief
          guest S. Shibhila Mary, Joint Director of Horticulture (i/c). 180+
          students participated from 60+ villages.
        </p>
        <p className="mb-3">
          June 21, 2022- Yoga Day was conducted with the help of NYK providing
          us with fund.{" "}
        </p>
        ...
        <p className="mb-3">
          November 13, 2022- Clean India 2.0 was conducted with the help of NYK
          providing us with fund.{" "}
        </p>
        ...
        <p className="mb-3">
          June 2023- Knowledge Competition was organised with the help of NYK
          providing us with fund.
        </p>
        <p className="mb-3">
          June 18, 2023- TALENT CHASE-3 was organised with 165 participants from
          60+ village and prizes were distributed.
        </p>
        <p className="mb-3">
          August 29, 2023- National Sports Day- Rashtriya Krida Diwas
          Celebration program was organised with the help of NYK providing us
          with fund.
        </p>
        <p className="mb-3">
          December 27, 2023- Provision of Groceries to the people staying at
          Abdul Kalam Kanavu Arakattalai, Mullikorai.
        </p>

        <h3 className="font-bold my-4 text-3xl">2024</h3>
        <p className="mb-3">
          January 27, 2024- National Youth Week Celebration was organised with
          the help of NYK providing us with fund.
        </p>
      </section>
    </>
  );
