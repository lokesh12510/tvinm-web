    ...
    return (
        <div
            className={`w-full fixed top-0 left-0 z-10 ${
                scrolled && "transistion-background duration-75 ease shadow-md backdrop-blur-sm bg-blue-100/80"
      ...
      text-gray-800"
                ...
                <div className="hidden md:block ">
                    <Link href={"/contact"}>
                        <Button className="bg-yellow-500 text-black shadow-lg hover:bg-yellow-500 ">CONTACT US</Button>
                    </Link>
                </div>
            </Container>
        </div>
