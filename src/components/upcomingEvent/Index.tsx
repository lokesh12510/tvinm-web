            ...
            <div className="grid grid-cols-12 gap-4 items-center">
                <div className="col-span-12 md:col-span-7 text-2xl my-[30px] md:my-0">
                    ...
                    <p className="text-white text-[1.3rem] leading-7 mb-3">
                        <span className="font-bold">Talent Chase 3</span> {`is an online competition conducted for the kids and school students. Talent Chase is a great platform to showcase the kid's talents to this world. A participant certificate will be provided for the participants and the winners will be awarded with cash prizes, certificates, medals and trophies.`}
                    </p>
